         ...
         jobjectArray  multi_sorted_order_matrix)
{
    ...
    try {
        ...
        int number_of_queries = env->GetArrayLength(query_param_matrix);
        jlong exported_handover_tableview_array[number_of_queries];
        ...
        std::unique_ptr<Query> queries[number_of_queries];
